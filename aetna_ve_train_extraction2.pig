SET job.name 'Aetna_DRG_Value_Estimation_Train'
SET pig.logfile 'Aetna_DRG_Value_Estimation_Train.log'
...
%declare ADMIT_DATA_PATH '/user/johnbrusk/Aetna/AdminDataForML_041316.csv'
...
%declare ADMIT_DATA_SCHEMA '(CnlyClaimNum:chararray, ConceptID:chararray, ConceptGroup:chararray, GrossIDAmt: double)' 
...
AdminDataB = Foreach AdminData Generate CnlyClaimNum, ConceptID, ConceptGroup, GrossIDAmt;
...
JFIX4 = Foreach JFIX3 Generate JFIX2::ADMIT_KEY as ADMIT_KEY, AdminDataA::ConceptID as ConceptID, AdminDataA::ConceptGroup as ConceptGroup, AdminDataA::GrossIDAmt as GrossIDAmt;
...
, (JFIX5::ConceptGroup == 'MS' ? '_MS-DRG' : 
		(JFIX5::ConceptGroup == 'APR' ? '_APR-DRG' :
			(JFIX5::ConceptGroup == 'AP' ? '_AP-DRG' :	'$dflt_drg_type' ))) as DRG_TYPE
...
, (double)JFIX5::GrossIDAmt as GrossIDAmt;
...
, MAX(AI.PAID) as PAID
, MAX(AI.GrossIDAmt) as GrossIDAmt;
...
rmf $DRG_VALUE_ESTMATION_TRAIN_SET_OUT_PATH
STORE AQ into '$DRG_VALUE_ESTMATION_TRAIN_SET_OUT_PATH' USING org.apache.pig.piggybank.storage.CSVExcelStorage('|', 'NO_MULTILINE', 'UNIX', 'WRITE_OUTPUT_HEADER'); 